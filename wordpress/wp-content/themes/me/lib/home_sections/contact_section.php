    <!-- SlideTo button-->
    <?php if ( !(checked(1, get_option('disable_slider'), false) && checked(1, get_option('disable_portfolio'), false) && checked(1, get_option('disable_services'), false) && checked(1, get_option('disable_about'), false)) ) : ?>
    ...
    <div id="contact">
          ...
          <div class="title">
               <h2>
                   ...
                   <?php endif; ?>
                   <?php if ( get_option('contact_title') ) : ?>
                   <span><?php echo get_option('contact_title'); ?></span>
                   <?php endif; ?>
               </h2>
          </div>
          <?php endif; ?>
